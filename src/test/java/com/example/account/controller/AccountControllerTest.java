...
class AccountControllerTest {
    ...
    // injection은 따로 안 한다
    // bean으로 등록해주는 mock이기 때문에 자동으로 주입된다
    @MockBean
    ...
    void successDeleteAccount() throws Exception {
        ...
        mockMvc.perform(delete("/account")
                        ...
                        .content(objectMapper.writeValueAsString( // createaccount 문자열로 변환
                ...
                .andDo(print());
        // content 안에는 요청할 정보가 들어가야 함
        // "userId" : name / "initialBalance" : 10000
    }
    ...
    void successGetAccount() throws Exception {
       ...
       given(accountService.getAccount(anyLong()))
        ...
        // then
        mockMvc.perform(get("/account/234"))
                .andDo(print())
                .andExpect(jsonPath("$.accountNumber").value("346"))
